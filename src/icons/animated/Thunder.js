...
const SvgThunder = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={64} height={64} {...props}>
    <defs>
      <filter id="thunder_svg__blur" width="200%" height="200%">
