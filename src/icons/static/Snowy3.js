...
const SvgSnowy3 = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={64} height={64} {...props}>
    <defs>
      <filter id="snowy-3_svg__a" width="200%" height="200%">
    ...
    <g filter="url(#snowy-3_svg__a)">
      <g transform="translate(20 26)">
        <g className="snowy-3_svg__am-weather-sun">
          <path
            fill="none"
            stroke="orange"
            strokeLinecap="round"
      ...
      <g
        ...
        stroke="#57A0EE"
        strokeLinecap="round"
        className="snowy-3_svg__am-weather-snow-1"
      >
      ...
      <g
        ...
        stroke="#57A0EE"
        strokeLinecap="round"
        className="snowy-3_svg__am-weather-snow-2"
      >
