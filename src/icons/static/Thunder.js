...
const SvgThunder = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={64} height={64} {...props}>
    <defs>
      <filter id="thunder_svg__a" width="200%" height="200%">
    ...
    <g filter="url(#thunder_svg__a)">
      <path
        ...
        strokeWidth={0.72}
        className="thunder_svg__am-weather-cloud-1"
      />
      <path
      ...
      />
      <path
        className="thunder_svg__am-weather-stroke"
        fill="orange"
        stroke="#fff"
