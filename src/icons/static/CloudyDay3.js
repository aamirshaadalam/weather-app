...
const SvgCloudyDay3 = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={64} height={64} {...props}>
    <defs>
      <filter id="cloudy-day-3_svg__a" width="200%" height="200%">
    ...
    <g filter="url(#cloudy-day-3_svg__a)">
      <g transform="translate(20 26)">
        <g className="cloudy-day-3_svg__am-weather-sun">
          <path
            fill="none"
            stroke="orange"
            strokeLinecap="round"
      ...
      <path
        ...
        strokeWidth={1.2}
        className="cloudy-day-3_svg__am-weather-cloud-2"
      />
    </g>
  </svg>
);
