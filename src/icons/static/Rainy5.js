...
const SvgRainy5 = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={64} height={64} {...props}>
    <defs>
      <filter id="rainy-5_svg__a" width="200%" height="200%">
    ...
    <g filter="url(#rainy-5_svg__a)">
      ...
      >
        <path
          className="rainy-5_svg__am-weather-rain-1"
          d="m27.918 45.943-1.39 7.878"
        />
        <path
          className="rainy-5_svg__am-weather-rain-2"
