...
const SvgCloudyNight2 = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={64} height={64} {...props}>
    <defs>
      <filter id="cloudy-night-2_svg__a" width="200%" height="200%">
    ...
    <g filter="url(#cloudy-night-2_svg__a)">
      <path
        fill="orange"
        d="m38.64 15.2.56.96.96.48-.96.56-.56.96-.48-.96-.96-.56.96-.48z"
        className="cloudy-night-2_svg__am-weather-moon-star-1"
      />
      <path
        fill="orange"
        d="m54.64 23.2.56.96.96.48-.96.56-.56.96-.48-.96-.96-.56.96-.48z"
        className="cloudy-night-2_svg__am-weather-moon-star-2"
      />
      <path
        ...
        strokeWidth={1.6}
        className="cloudy-night-2_svg__am-weather-moon"
      />
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.2}
        className="cloudy-night-2_svg__am-weather-cloud-2"
      />
    </g>
  </svg>
);
